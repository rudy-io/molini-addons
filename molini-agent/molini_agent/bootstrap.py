...
MOLI_HA_CONFIG_PATCH: dict[str, Any] = {
    ...
    "frontend": {
        ...
        # bordures fines plutôt qu'ombres, fonte Archivo (moli-brand.js).
        # Appliqué par vue via `theme: Moli` dans les blocs. Les clés de
        # l'ancien thème navy sont TOUTES réécrites (deep-merge = overwrite
        # des scalaires) — pas de reliquat.
        "themes": {
            "Moli": {
                # Interactif : cuivre (le jaune pur est illisible en petit) ;
                # l'accent jaune reste pour les états actifs/toggles.
                "primary-color": "#8A6A14",
                "accent-color": "#FFD337",
                "app-header-background-color": "#161510",
                "app-header-text-color": "#F2F0EA",
                "primary-background-color": "#F2F0EA",
                "secondary-background-color": "#F2F0EA",
                "divider-color": "#DCD8CC",
                "card-background-color": "#FBFAF6",
                "ha-card-background": "#FBFAF6",
                "ha-card-border-radius": "2px",
                "ha-card-border-width": "1px",
                "ha-card-border-color": "#DCD8CC",
                "ha-card-box-shadow": "none",
                "primary-text-color": "#161510",
                "secondary-text-color": "#5C594E",
                "text-primary-color": "#F2F0EA",
                "state-icon-color": "#8A6A14",
                "paper-item-icon-color": "#5C594E",
                "paper-item-icon-active-color": "#8A6A14",
                "switch-checked-color": "#FFD337",
                "switch-checked-button-color": "#FFD337",
                "switch-checked-track-color": "#FFE382",
                "slider-color": "#8A6A14",
                "slider-track-color": "#DCD8CC",
                "sidebar-background-color": "#F2F0EA",
                "sidebar-text-color": "#5C594E",
                "sidebar-icon-color": "#5C594E",
                "sidebar-selected-text-color": "#161510",
                "sidebar-selected-icon-color": "#8A6A14",
                # Typo — Archivo (déclarée par moli-brand.js, servie en local)
                "primary-font-family": "Archivo, ui-sans-serif, system-ui, sans-serif",
                "paper-font-common-base_-_font-family": "Archivo, sans-serif",
                "paper-font-common-code_-_font-family": "Archivo, sans-serif",
                "paper-font-body1_-_font-family": "Archivo, sans-serif",
                "paper-font-subhead_-_font-family": "Archivo, sans-serif",
                "paper-font-headline_-_font-family": "Archivo, sans-serif",
                "paper-font-caption_-_font-family": "Archivo, sans-serif",
                "paper-font-title_-_font-family": "Archivo, sans-serif",
                "mdc-typography-font-family": "Archivo, sans-serif",
                "ha-card-header-font-family": "Archivo, sans-serif",
            },
        },
    },
}
